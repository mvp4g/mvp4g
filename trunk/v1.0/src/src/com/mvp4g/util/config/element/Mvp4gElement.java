...
/**
 * A representation of an Mvp4g configuration element.<p/>
 * 
...
public abstract class Mvp4gElement {
	 ...
	 * 
	 * The value associated with the property name returned by this method must
	 * be globally unique across the entire mvp4g configuration.
	 * 
	 ...
	 * 
	 * @return if defined, a value uniquely identifying the element,
	 * 		   if not defined, an empty string.
	 */
	...
	/**
	 * Returns the name of the XML tag used to represent this element in the Mvp4g configuration file.
	 * 
	 * @return
	 * 			name of the Mvp4gElement tag.
	 */
