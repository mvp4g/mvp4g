 ...
 * <ol>
 * <li/><i>view</i>: a required attribute specifying which view to render upon
 *                   application startup;
 * <li/><i>eventType</i>: an optional attribute specifying the event to be
 * 					 broadcasted upon application startup.
 * </ol>
 * 
 * Because every GWT application always needs to render a view at startup, this
 * element is required. 
 * 
 * @author javier
 *
