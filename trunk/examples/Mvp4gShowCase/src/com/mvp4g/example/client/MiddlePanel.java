...
//  private TabPanel tabPanel      = new TabPanel();
  ...
  public MiddlePanel() {
    ...
    demo.setStyleName("demo-frame");

//    tabPanel.add(demo,
//                 "Demo");
//    tabPanel.add(eventbus,
//                 "Event Bus Interface");
//
...
//    eventbus.setUrl("http://code.google.com/p/mvp4g/source/browse/tags/mvp4g-1.5.0/examples/" + item.getProjectName()
//                    + "/src/com/mvp4g/example/client/" + item.getEventBusName() + ".java");
//    tabPanel.selectTab(0);
//
//    int nbTab = tabPanel.getTabBar()
//                        .getTabCount();
//    if (!item.isWithXml()) {
//      if (nbTab == 3) {
...
//      }
//    } else {
//      configuration.setUrl("http://mvp4g.googlecode.com/svn/tags/mvp4g-1.5.0/examples/" + item.getProjectName() + "Xml/src/mvp4g-conf.xml");
//      if (nbTab < 3) {
//        tabPanel.add(configuration,
//                     "Mvp4g XML Configuration");
//      }
//    }
