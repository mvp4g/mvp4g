...
public class Mailboxes_Images_default_InlineClientBundleGenerator implements com.mvp4g.example.client.view.widget.Mailboxes.Images {
  ...
  static {
    new Mailboxes_Images_default_InlineClientBundleGenerator()._init0();
  }
  ...
  private native ResourcePrototype getResourceNative(String name) /*-{
    switch (name) {
      case 'drafts': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::drafts()();
      case 'home': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::home()();
      case 'inbox': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::inbox()();
      case 'sent': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::sent()();
      case 'templates': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::templates()();
      case 'trash': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::trash()();
      case 'treeClosed': return this.@com.google.gwt.user.client.ui.Tree.Resources::treeClosed()();
      case 'treeLeaf': return this.@com.mvp4g.example.client.view.widget.Mailboxes.Images::treeLeaf()();
