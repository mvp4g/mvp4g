...
@Presenter(view = IShortCutsView.class)
public class ShortCutsPresenter
    extends BasePresenter<IShortCutsView, MailEventBus>
    implements IShortCutsPresenter {

  private Contact[] contacts = new Contact[]{new Contact("Benoit Mandelbrot",
                                                         "benoit@example.com"),
                                                new Contact("Albert Einstein",
                                                            "albert@example.com"), new Contact("Rene Descartes",
                                                                                               "rene@example.com"),
                                                new Contact("Bob Saget",
                                                            "bob@example.com"), new Contact("Ludwig von Beethoven",
                                                                                            "ludwig@example.com"),
                                                new Contact("Richard Feynman",
                                                            "richard@example.com"), new Contact("Alan Turing",
                                                                                                "alan@example.com"),
                                                new Contact("John von Neumann",
                                                            "john@example.com")};
  ...
  @Override
  public void bind() {
    eventBus.setShortCutsView(view.asWidget());
  }
  ...
  public void onStart() {
    ...
    for (i = 0; i < contacts.length; i++) {
      view.addContact(contacts[i].getName(),
                      i);
    }
  ...
  public void onContactClick(int index,
    ...
    view.showContactPopup(contact.getName(),
                          contact.getEmail(),
                          contactWidget);
  }
