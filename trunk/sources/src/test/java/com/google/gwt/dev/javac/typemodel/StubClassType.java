...
import com.mvp4g.util.test_tools.TestMvp4gRunAsyncCallback;
...
public class StubClassType extends JClassType {
	...
	public JMethod[] getOverridableMethods() {
		...
		new JParameter( method, oracle.findType( TestMvp4gRunAsyncCallback.class.getCanonicalName() ), "callback", declaredAnnotations );
