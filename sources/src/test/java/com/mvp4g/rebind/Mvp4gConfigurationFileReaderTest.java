...
//	}
	...
	private String[] getExpectedPresenters() {
		return new String[] {
				"final com.mvp4g.rebind.test_tools.RootPresenter rootPresenter = injector.getrootPresenter();",
	...
	private String[] getExpectedEvents() {
		return new String[] {
				...
				"if(handlershandler2!= null){", "com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter handler;",
	...
	private String[] getExpectedLoadChildModuleWithLoader() {
		return new String[] { "final Object[] params = (passer == null) ? null : passer.getEventObjects();",
				...
				"com.mvp4g.rebind.test_tools.Loaders.Loader1 loader;", "loader = injector.getloader();" };
	}
	...
	private String[] getExpectedDetailedDebug() {
		return new String[] { "protected com.mvp4g.rebind.test_tools.OneLogger logger;",
				...
				"logger = injector.getcom_mvp4g_rebind_test_tools_OneLogger();", "int startLogDepth = BaseEventBus.logDepth;",
				"++BaseEventBus.logDepth;", "++BaseEventBus.logDepth;", "BaseEventBus.logDepth = startLogDepth;",
	...
	private String[] getExpectedActivateDeactivate() {
		return new String[] {
				...
				"if(handlershandler4act!= null){", "com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent handler;",
	...
	public String[] getExpectedGenerateEvents() {
		return new String[] {
				"com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter handler2 = BaseEventBus.setPresenter(false, injector.gethandler2(), injector.getview(), eventBus);",
