...
public class Mvp4gConfigurationTest {
	...
	public void testChildModulesNoStart() throws InvalidMvp4gConfigurationException {
		...
		try {
			...
			assertEquals(
					"Module com.mvp4g.rebind.test_tools.Modules.Module1: You must define a start presenter since this module has a parent module that uses the auto-displayed feature for this module.",
					e.getMessage() );
			throw e;
		}
	}
