...
public class EventHandlerAnnotationsLoader extends Mvp4gAnnotationsWithServiceLoader<EventHandler> {
     ...
     * 
     * @see
     * com.mvp4g.util.config.loader.annotation.Mvp4gAnnotationsWithServiceLoader
     * #loadElementWithServices (com.google.gwt.core.ext.typeinfo.JClassType,
     * java.lang.annotation.Annotation,
     * com.mvp4g.util.config.Mvp4gConfiguration)
     */
    @Override
    Mvp4gWithServicesElement loadElementWithServices(JClassType c, EventHandler annotation, Mvp4gConfiguration configuration) throws Mvp4gAnnotationException {
