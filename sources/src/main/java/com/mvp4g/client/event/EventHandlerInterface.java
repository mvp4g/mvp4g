...
public interface EventHandlerInterface<E extends EventBus> {
    ...
    /**
     * Indicates if the presenter is activated or not. If the presenter is
     * activated and if the bind method hasn't been called yet, then the bind
    ...
    /**
     * Set if the presenter is activated or not. By default, a presenter should
     * be activated.
     * 
     * @param activated
