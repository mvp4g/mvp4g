...
/**
 * This annotation indicates what event should be by Place Service in case the token is empty or doesn't correspond to an event type.<br/>
 * <br/>
