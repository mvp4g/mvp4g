 ...
 * attribute <i>name</i> and <i>viewName</i>. If you don't give a name, the framework will generate one.<br/>
 ...
 * <view name="rootTemplateView" class="RootTemplateView" />}<br/>
 * and<br/>
 * {@code <presenter name="rootTemplate" class="RootTemplatePresenter" view="rootTemplateView" />}
 * 
 * 
 * @author plcoirier
 * 
