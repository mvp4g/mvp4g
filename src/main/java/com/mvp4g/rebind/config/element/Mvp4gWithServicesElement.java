...
/**
 * A simple Mvp4g configuration element with services.<br>
 * <br>
 * This element also have the following attributes:
 * <ul>
 * <li><i>services</i>: list of the services to inject to the element</li>
 * </ul>
 *
 * @author plcoirier
 */
public class Mvp4gWithServicesElement
  ...
  private void setServices(String[] services) {
    ...
    for (String service : services) {
      if ((service != null) && (service.length() > 0)) {
        injectedServices.add(new InjectedElement(service,
                                                 "set" + capitalized(service)));
      }
    }
