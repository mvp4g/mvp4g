...
import com.mvp4g.rebind.test_tools.annotation.Events.TestLogger;
...
public class EventsAnnotationsLoaderTest {
  ...
  public void testOtherEventBus() {
    try {
      configuration.setEventBus(new EventBusElement(Object.class.getName(),
      ...
      assertEquals(e.getMessage(),
                   Events.SimpleEventBus.class.getCanonicalName() +
  ...
  public void testNotInterface()
    ...
    try {
      ...
      assertTrue(e.getMessage()
                  .contains("annotation can only be used on interfaces."));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testNotEventBus()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
  ...
  public void testEventBus()
    ...
    assertEquals(BaseEventBus.class.getName(),
                 eventBus.getAbstractClassName());
    assertEquals(type.getQualifiedSourceName(),
                 eventBus.getInterfaceClassName());
    assertFalse(eventBus.isWithLookUp());
  }

  @Test
  public void testEventBusWithLookup()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(SimplePresenter01.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
    ...
    loader.load(annotedClasses,
                configuration);
    EventBusElement eventBus = configuration.getEventBus();
    assertEquals(BaseEventBusWithLookUp.class.getName(),
                 eventBus.getAbstractClassName());
    assertEquals(type.getQualifiedSourceName(),
                 eventBus.getInterfaceClassName());
  ...
  public void testStart()
    ...
    assertEquals(configuration.getPresenters()
                              .iterator()
                              .next()
                              .getName(),
                 start.getPresenter());
    assertFalse(start.hasHistory());
    assertTrue(configuration.getStart()
                            .hasPresenter());
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testStartNoView()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      JClassType       type           = oracle.addClass(Events.SimpleEventBus.class);
      ...
      assertTrue(e.getMessage()
                  .contains("There is no instance of"));
      throw e;
    }
  }

  @Test
  public void testStartWithName()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
  ...
  @Test(expected = Mvp4gAnnotationException.class)
  public void testStartNoViewName()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      JClassType       type           = oracle.addClass(Events.EventBusWithStartName.class);
      ...
      assertTrue(e.getMessage()
                  .contains("There is no presenter named"));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testStartWrongViewClass()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("There is no instance with name"));
      assertTrue(e.getMessage()
                  .contains("that extends"));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testEventNoAnnotation()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(SimplePresenter01.class));
  ...
  public void testDoubleStart()
    ...
    try {
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for Start event. It is already defined by another method."));
      throw e;
    }
  }
  ...
  public void testDoubleForward()
    ...
    try {
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for Forward event. It is already defined by another method."));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testDoubleInitHistory()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for Init History event. It is already defined by another method or in your configuration file."));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testDoubleNotFoundHistory()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for Not Found History event. It is already defined by another method or in your configuration file."));
      throw e;
    }
  }
  ...
  @Test(expected = Mvp4gAnnotationException.class)
  public void testNoInstanceOfHistory()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
  ...
  public void testEventOk()
    ...
    new HistoryAnnotationsLoader().load(annotedClasses,
                                        configuration);
    ...
    for (EventElement e : events) {
      if ("event1".equals(e.getType())) {
        assertEquals(String.class.getName(),
                     e.getEventObjectClass()[0]);
        assertEquals("treatEvent1",
                     e.getCalledMethod());
  ...
  @Test(expected = Mvp4gAnnotationException.class)
  public void testEventBusWithSameChild()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      ...
      assertTrue(e.getMessage()
                  .contains("You can't have two child modules describing the same module: " + Modules.Module01.class.getCanonicalName()));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testUselessChildModulesBus()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      ...
      assertTrue(e.getMessage()
                  .contains("Useless " + ChildModules.class.getSimpleName() + " annotation. Don't use this annotation if your module doesn't have any child module."));
      throw e;
    }
  }

  @Test
  public void testEventBusWithChildrenOk()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
    ...
    for (ChildModuleElement child : childModules) {
      if (Modules.Module01.class.getCanonicalName()
                                .equals(child.getClassName())) {
        assertTrue(child.isAsync());
        assertTrue(child.isAutoDisplay());
        assertEquals("event1",
                     child.getEventToDisplayView());
      } else if (Modules.ModuleWithParent01.class.getCanonicalName()
                                                 .equals(child.getClassName())) {
    ...
    for (EventElement e : events) {
      if ("event1".equals(e.getType())) {
        ...
        assertEquals(2,
                     modules.size());
        assertEquals(Modules.ModuleWithParent01.class.getCanonicalName()
                                                     .replace(".",
                                                              "_"),
                     modules.get(0));
        assertEquals(Modules.Module01.class.getCanonicalName()
  ...
  @Test
  public void testEventBusWithSiblingOk()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
  ...
  @Test(expected = Mvp4gAnnotationException.class)
  public void testDoubleBeforeLoadChild()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for Before Load Child event. It is already defined by another method or in your configuration file."));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testDoubleAfterLoadChild()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for After Load Child event. It is already defined by another method or in your configuration file."));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testDoubleErrorLoadChild()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("Duplicate value for Error Load Child event. It is already defined by another method or in your configuration file."));
      throw e;
    }
  }

  @Test
  public void testLoadChildConfigOk()
    throws Mvp4gAnnotationException {
    ...
    assertEquals("event1",
                 childModules.getBeforeEvent());
    assertEquals("event2",
                 childModules.getAfterEvent());
    assertEquals("event3",
                 childModules.getErrorEvent());

  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testUnknownModuleForLoadModuleViewEvent()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("No instance of " + Modules.ModuleWithParent01.class.getCanonicalName() + " is defined."));
      throw e;
    }
  }

  @Test(expected = Mvp4gAnnotationException.class)
  public void testSameModuleForLoadModuleViewEvent()
    throws Mvp4gAnnotationException {
    try {
      List<JClassType> annotedClasses = new ArrayList<JClassType>();
      annotedClasses.add(oracle.addClass(PresenterWithName.class));
      ...
      assertTrue(e.getMessage()
                  .contains("Module " + Modules.Module01.class.getCanonicalName() + ": you can't have two events to load this module view."));
      throw e;
    }
  }
  ...
  @Test
  public void testEventNoFilterWithForceBus()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
  ...
  @Test
  public void testEventBusFilters()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
  ...
  @Test
  public void testEventBusFiltersWithParam()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
  ...
  @Test
  public void testEventBusSameFilter()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
    ...
    try {
      ...
      assertTrue(e.getMessage()
                  .contains("Multiple definitions for event filter " + EventFilters.EventFilter1.class.getCanonicalName() + "."));
    }
  }

  @Test
  public void testDefaultGin()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(SimplePresenter01.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
    ...
    assertTrue(configuration.getGinModule()
                            .getModuleProperties().length == 0);
  ...
  public void testGin()
    ...
    assertEquals("property1",
                 configuration.getGinModule()
                              .getModuleProperties()[0]);

  }

  @Test
  public void testGins()
    throws Mvp4gAnnotationException {
    List<JClassType> annotedClasses = new ArrayList<JClassType>();
    annotedClasses.add(oracle.addClass(PresenterWithName.class));
    new PresenterAnnotationsLoader().load(annotedClasses,
  ...
  public void testDefaultLogger()
    ...
    loader.load(annotedClasses,
                configuration);
    assertEquals(configuration.getDebug()
                              .getLogger(),
                 DefaultMvp4gLogger.class.getCanonicalName());
    assertEquals(configuration.getDebug()
                              .getLogLevel(),
                 LogLevel.SIMPLE.toString());
  ...
  public void testCustomLogger()
    ...
    assertEquals(configuration.getDebug()
                              .getLogger(),
                 TestLogger.class.getCanonicalName());
    assertEquals(configuration.getDebug()
                              .getLogLevel(),
                 LogLevel.DETAILED.toString());
  ...
  @Test
  public void testNoHistoryConfiguration()
    throws Mvp4gAnnotationException {
  ...
  public void testNoStartView()
    ...
    assertNull(configuration.getStart()
                            .getPresenter());
    assertFalse(configuration.getStart()
                             .hasPresenter());
