...
public class Mvp4gConfigurationFileReaderTest {
  ...
  public void setUp() {
    ...
    configuration = new Mvp4gConfiguration(tl,
                                           new GeneratorContextStub());
    writer = new Mvp4gConfigurationFileWriter(sourceWriter,
                                              configuration);

    String eventBusInterface = EventBus.class.getName();
    String eventBusClass     = BaseEventBus.class.getName();
    configuration.setEventBus(new EventBusElement(eventBusInterface,
                                                  eventBusClass,
                                                  false));
  ...
  public void testWriteEventBusClass() {
    ...
    String[] output = { "private abstract class AbstractEventBus extends " + eventBus.getAbstractClassName() + " implements " + eventBus.getInterfaceClassName() + "{}" };
  ...
  public void testWriteEvents() {
    ...
    assertOutput(getExpectedEvents(),
                 false);
    assertOutput(getExpectedNotNavigationEvents(),
                 false);
    assertOutput(getExpectedEventsInheritMethods(),
                 false);
    assertOutput(getExpectedEventsWithLookup(),
                 false);
    assertOutput(getExpectedNavigationEvents(),
                 false);
    assertOutput(getExpectedGenerateEvents(),
                 false);
    assertOutput(getExpectedBindedEvents(),
                 false);
    ...
    e1.setEventObjectClass(new String[] { "java.lang.String",
                                          "java.lang.Object" });
  ...
  private String[] getExpectedEvents() {
    return new String[] { "public void event4(){",
                          "List<com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent> handlershandler4 = getHandlers(com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent.class);",
                          "if(handlershandler4!= null){",
                          "com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent handler;",
                          ...
                          "List<com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter> handlershandler2 = getHandlers(com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter.class);",
                          "if(handlershandler2!= null){",
                          "com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter handler;",
                          "int handlerCount = handlershandler2.size();",
                          "for(int i=0; i<handlerCount; i++){",
                          "handler = handlershandler2.get(i);",
                          "if (handler.isActivated(false, \"event2\", new Object[]{attr0})){",
                          "handler.onEvent2(attr0);",
                          "public void event3(){",
                          "if (handler3.isActivated(false, \"name3\")){",
                          "if (handler3.isActivated(true, \"event4\")){",
                          "handler3.onEvent4();",
                          "handler3.onEvent3();",
                          "if (handler1.isActivated(false, \"event1\", new Object[]{attr0,attr1})){",
  ...
  private String[] getExpectedEventsWithLookup() {
    return new String[] { "public void dispatch( String eventType, Object... data ){",
                          "try{",
  ...
  public String[] getExpectedGenerateEvents() {
    return new String[] { "com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter handler2 = BaseEventBus.setPresenter(false, injector.gethandler2(), injector.getview(), eventBus);",
                          "eventBus.finishAddHandler(handler2,com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter.class, true);",
                          "com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter handler6 = BaseEventBus.setPresenter(true, injector.gethandler6(), injector.getview(), eventBus);",
                          "eventBus.finishAddHandler(handler6,com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter.class, true);",
                          "com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent handler4 = BaseEventBus.setEventHandler(injector.gethandler4(), eventBus);",
                          "eventBus.finishAddHandler(handler4,com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent.class, true);",
                          "if (handler2.isActivated(true, \"event4\")){",
                          "handler2.onEvent4();",
                          "if (handler4.isActivated(true, \"event4\")){",
                          "handler4.onEvent4();",
                          "if (handler6.isActivated(true, \"event4\")){",
                          "handler6.onEvent4();" };
  }

  private String[] getExpectedBindedEvents() {
    return new String[] { "handler3.isActivated(false, \"event1\", new Object[]{attr0,attr1});",
                          "List<com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter> handlershandler2 = getHandlers(com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter.class);",
                          "if(handlershandler2!= null){",
                          "com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter handler;",
                          "int handlerCount = handlershandler2.size();",
  ...
  private void createHandlers() {
    ...
    p1.setClassName(SimplePresenter01.class.getCanonicalName());
    p1.setView("view");
    ...
    eh1.setClassName(SimpleEventHandler01.class.getCanonicalName());
  ...
  public void testWriteActivateDeactivate() {
    ...
    assertOutput(getExpectedActivateDeactivate(),
                 false);
    ...
    e1.setType("event1");
    e1.setHandlers(new String[] { "handler1" });
    e1.setActivate(new String[] { "handler3",
                                  "handler4" });
    e1.setEventObjectClass(new String[] { "java.lang.String",
                                          "java.lang.Object" });
    ...
    e3.setType("event3");
    e3.setHandlers(new String[] { "handler3" });
    e3.setDeactivate(new String[] { "handler1",
                                    "handler2" });
  ...
  private String[] getExpectedActivateDeactivate() {
    return new String[] { "handler1.setActivated(false);",
                          "List<com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter> handlershandler2de = getHandlers(com.mvp4g.rebind.test_tools.annotation.Presenters.MultiplePresenter.class);",
                          ...
                          "List<com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent> handlershandler4act = getHandlers(com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent.class);",
                          "if(handlershandler4act!= null){",
                          "com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent handler;",
                          "int handlerCount = handlershandler4act.size();",
                          "for(int i=0; i<handlerCount; i++){",
                          "handler = handlershandler4act.get(i);",
  ...
  public void testWriteEventsWithToken() {
    ...
    assertOutput(getExpectedEventsWithToken(),
                 false);
    ...
    e3.setEventObjectClass(new String[] { "java.lang.String",
                                          "java.lang.Object" });
  ...
  public String[] getExpectedEventsWithToken() {
    return new String[] { "public String event2(java.lang.String attr0,java.lang.Object attr1){",
                          "if(tokenMode){",
                          "tokenMode=false;",
                          "((com.mvp4g.client.event.BaseEventBus) parentEventBus).tokenMode = true;",
                          "return parentEventBus.event2(attr0,attr1);",
                          "} else {",
                          "return null;",
                          "public String event1(java.lang.String attr0,java.lang.Object attr1){",
                          "return place( itself, \"event1\",history.onEvent1(attr0,attr1),true);",
                          "return place( itself, \"event3\",history.onEvent3(attr0,attr1),true);",
                          "public String event3(final java.lang.String attr0,final java.lang.Object attr1){",
                          "return;" };
  }
  ...
  private void testWriteEventsWithHistory(boolean withToken) {
    ...
    assertOutput(getExpectedHistoryEvents(false),
                 false);
    assertOutput(getExpectedHistoryEvents(),
                 false);
    ...
    e5.setEventObjectClass(new String[] { "java.lang.String",
                                          "java.lang.Object" });
  ...
  private String[] getExpectedHistoryEvents(boolean withToken) {
    return new String[] { "place( itself, \"historyName\",history.onEvent2(attr0)," + withToken + ");",
                          "place( itself, \"event1\",history.onEvent1(attr0,attr1)," + withToken + ");",
                          "place( itself, \"event4\",null," + withToken + ");",
  ...
  private String[] getExpectedHistoryEvents() {
    return new String[] { "clearHistory(itself);",
                          "addConverter( \"event4\",history2);",
                          "addConverter( \"historyName\",history);",
                          "addConverter( \"event1\",history);",
                          "addConverter( \"event5\",history3);",
                          "addConverter( \"event6\",history3);",
  ...
  public void testWriteEventsWithGenerate() {
    ...
    e4.setHandlers(new String[] { "handler3",
                                  ...
                                  "handler6" });
    e4.setPassive("true");
    e4.setGenerate(new String[] { "handler2",
                                  "handler4",
                                  "handler6" });
  ...
  public void testWriteViews() {
    ...
    view1.setClassName("com.mvp4g.rebind.test_tools.RootView");
  ...
  private String[] getExpectedViews() {
    return new String[] { "final com.mvp4g.rebind.test_tools.RootView " + "rootView = injector.getrootView();",
  ...
  public void testWritePresenters() {
    ...
    p1.setClassName("com.mvp4g.rebind.test_tools.RootPresenter");
    p1.setView("rootView");
    ...
    p2.getInjectedServices()
      .add(new InjectedElement("userService",
                               "setUserService"));
    ...
    assertOutput(getExpectedPresenters(),
                 false);
    assertOutput(getReverseView(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedPresenters(),
                 true);
  ...
  private String[] getExpectedPresenters() {
    return new String[] { "final com.mvp4g.rebind.test_tools.RootPresenter rootPresenter = injector.getrootPresenter();",
                          ...
                          "final com.mvp4g.example.client.presenter.display.UserDisplayPresenter " + "displayUserPresenter = injector.getdisplayUserPresenter();",
  ...
  public void testWriteMultiplePresenters() {
    ...
    view.setClassName("com.mvp4g.rebind.test_tools.RootView");
...
//	}
  ...
  private String[] getMultiplePresenters(boolean reverse) {
    return new String[] { "if (com.mvp4g.rebind.test_tools.RootPresenter.class.equals(handlerClass)){",
  ...
  public void testWriteServices() {
    ...
    assertOutput(getExpectedServices(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedServices(),
                 true);
  ...
  private String[] getExpectedServices() {
    return new String[] { "final com.mvp4g.example.client.rpc.UserServiceAsync " + "userRpcService = GWT.create(com.mvp4g.example.client.rpc.UserService.class);",
                          "final com.mvp4g.example.client.services.UserServiceAsync " + "userService = GWT.create(com.mvp4g.example.client.services.UserService.class);",
                          "((ServiceDefTarget) userService).setServiceEntryPoint(\"/service/user\");",
                          "final com.mvp4g.example.client.services.display.UserServiceAsync " + "userDisplayService = GWT.create(com.mvp4g.example.client.services.display.UserService.class);" };
  }
  ...
  public void testWriteStart() {
    ...
    assertOutput(getExpectedStartEvent(),
                 false);
    assertOutput(getExpectedNoFiltering(),
                 false);
    assertOutput(getExpectedStartPresenterViewCommon(),
                 false);
    assertOutput(getExpectedStartPresenterView(),
                 false);
    assertOutput(getExpectedStartPresenterViewMultiple(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedStartEvent(),
                 true);
  ...
  private String[] getExpectedStartEvent() {
    return new String[] { "eventBus.start();",
                          "startPresenter.setActivated(true);",
                          "HistoryProxyProvider.INSTANCE.get().fireCurrentHistoryState();" };
  }
  ...
  public void testWriteStartMultiple() {
    ...
    configuration.getPresenters()
                 .iterator()
                 .next()
                 .setMultiple(Boolean.TRUE.toString());
  ...
  public void testWriteNoForward() {
    ...
    assertOutput(getExpectedNoForwardEvent(),
                 false);
    assertOutput(getExpectedForwardEvent(),
                 false);
    assertOutput(getExpectedNoFiltering(),
                 false);
    writer.writeConf();
  ...
  public void testHistory() {
    ...
    assertOutput(getExpectedWithHistory(),
                 false);
    assertOutput(getExpectedInheritModuleMethods(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedDefaultHistory(),
                 true);
  ...
  private String[] getExpectedWithHistory() {
    return new String[] { "eventBus.init();",
                          "eventBus.notFound()",
  ...
  private String[] getExpectedHistoryWithConfig() {
    return new String[] { "com.mvp4g.rebind.test_tools.CustomPlaceService getcom_mvp4g_rebind_test_tools_CustomPlaceService();",
                          "placeService = injector.getcom_mvp4g_rebind_test_tools_CustomPlaceService();" };
  ...
  public void testWriteGetters() {
    ...
    assertOutput(getExpectedGetters(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedGetters(),
                 true);
  ...
  private String[] getExpectedGetters() {
    return new String[] { "public Object getStartView(){",
                          "return startView;",
  ...
  public void testWriteNoParent() {
    assertOutput(getExpectedSetNoParent(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedSetNoParent(),
                 true);
  ...
  private String[] getExpectedSetNoParent() {
    return new String[] { "public void setParentModule(com.mvp4g.client.Mvp4gModule module){}",
  ...
  public void testWriteParent() {
    ...
    assertOutput(new String[] { "private PlaceService placeService = null;" },
                 false);
    assertOutput(getExpectedSetParent(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedSetParent(),
                 true);
  ...
  public void testWriteChildNoAsyncNoAutoLoad() {
    ...
    assertOutput(getExpectedChildModule(Modules.ModuleWithParent01.class.getCanonicalName()),
                 false);
    assertOutput(getExpectedAsyncChildModule(),
                 false);
    assertOutput(getExpectedAutoDisplayChildModule(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedChildModule(Modules.ModuleWithParent01.class.getCanonicalName()),
                 true);
  ...
  private String[] getExpectedChildModule(String moduleClassName) {
    return new String[] { "private void loadchildModule(final String eventName, final Mvp4gEventPasser passer){",
                          moduleClassName + " newModule = (" + moduleClassName + ") modules.get(\"" + moduleClassName + "\");",
                          "if(newModule == null){",
                          "newModule = GWT.create(" + moduleClassName + ".class);",
                          "modules.put(\"" + moduleClassName + "\", newModule);",
  ...
  private String[] getExpectedAsyncChildModule() {
    return new String[] { "eventBus.beforeLoad();",
  ...
  public void testWriteChildWithParentAsyncNoAutoLoadErrorEmpty() {
    ...
    assertOutput(getExpectedChildModule(Modules.Module01.class.getCanonicalName()),
                 false);
    assertOutput(getExpectedAsyncChildModuleErrorEmpty(),
                 false);
    assertOutput(getExpectedAutoDisplayChildModule(),
                 false);
    writer.writeConf();
  ...
  public void testWriteLoadChildModule() {
    ...
    assertOutput(getExpectedLoadChildModule(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedLoadChildModule(),
                 true);
  ...
  private String[] getExpectedLoadChildModule() {
    return new String[] { "public void loadChildModule(String childModuleClassName, String eventName, boolean passive, Mvp4gEventPasser passer){",
                          "Mvp4gModule childModule = modules.get(childModuleClassName);",
                          "if((childModule != null) && (passer != null)){",
                          "passer.pass(childModule);",
                          "else if(\"com.mvp4g.rebind.test_tools.Modules.ModuleWithParent01\".equals(childModuleClassName)){",
                          "loadchildModule2(eventName, passer);",
                          "else if(\"com.mvp4g.rebind.test_tools.Modules.Module01\".equals(childModuleClassName)){",
  ...
  public void testWriteLoadChildModuleWithLoader() {
    ...
    assertOutput(getExpectedLoadChildModuleWithLoader(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedLoadChildModuleWithLoader(),
                 true);
  ...
  private String[] getExpectedLoadChildModuleWithLoader() {
    return new String[] { "final Object[] params = (passer == null) ? null : passer.getEventObjects();",
                          "loader.preLoad( eventBus, eventName, params, new Command(){",
                          "public void execute() {",
                          "loader.onFailure( eventBus, eventName, params, reason );",
                          "loader.onSuccess(eventBus, eventName, params );",
                          "com.mvp4g.rebind.test_tools.Loaders.Loader1 loader;",
                          "loader = injector.getloader();" };
  }
  ...
  public void testWriteChildEvent() {
    ...
    event3.setEventObjectClass(new String[] { "java.lang.String",
                                              "java.lang.Object" });
    ...
    configuration.getOthersEventBusClassMap()
                 .put(Modules.ModuleWithParent01.class.getCanonicalName(),
                      oracle.addClass(EventBusOk.class));

    assertOutput(getExpectedEventChildModuleLoad(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedEventChildModuleLoad(),
                 true);
  ...
  private String[] getExpectedEventChildModuleLoad() {
    return new String[] { "loadchild(\"event2\", new Mvp4gEventPasser(new Object[]{attr0}){",
                          "public void pass(Mvp4gModule module){",
  ...
  public void testWriteChildPassiveEvent() {
    ...
    assertOutput(getExpectedPassiveEventChildModuleLoad(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedPassiveEventChildModuleLoad(),
                 true);
  ...
  private String[] getExpectedPassiveEventChildModuleLoad() {
    return new String[] { "Mvp4gModule module;",
  ...
  public void testWriteForwardParent() {
    ...
    assertOutput(getExpectedForwardParent(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedForwardParent(),
                 true);
  ...
  private void testWriteSiblingEvent(boolean passive) {
    ...
    assertOutput(getExpectedEventSiblingLoad(passive),
                 false);
    writer.writeConf();
    assertOutput(getExpectedEventSiblingLoad(passive),
                 true);
  ...
  private String[] getExpectedEventSiblingLoad(boolean passive) {
    return new String[] { "parentModule.loadChildModule(\"com.mvp4g.rebind.test_tools.Modules.ModuleWithParent01\", \"event1\", " + passive + ", new Mvp4gEventPasser(){",
                          "public void pass(Mvp4gModule module){",
                          "com.mvp4g.rebind.test_tools.annotation.events.EventBusOk eventBus = (com.mvp4g.rebind.test_tools.annotation.events.EventBusOk) module.getEventBus();",
                          "eventBus.event1();",
                          "parentModule.loadChildModule(\"com.mvp4g.rebind.test_tools.Modules.ModuleWithParent01\", \"event2\", " + passive + ", new Mvp4gEventPasser(new Object[]{attr0}){",
                          "eventBus.event2((java.lang.String) eventObjects[0]);",
                          "parentModule.loadChildModule(\"com.mvp4g.rebind.test_tools.Modules.ModuleWithParent01\", \"event3\", " + passive + ", new Mvp4gEventPasser(new Object[]{attr0,attr1}){",
                          "eventBus.event3((java.lang.String) eventObjects[0],(java.lang.Object) eventObjects[1]);" };
  }
  ...
  private String[] getExpectedDebug() {
    return new String[] { "protected com.mvp4g.client.event.DefaultMvp4gLogger logger;",
                          ...
                          "logger = injector.getcom_mvp4g_client_event_DefaultMvp4gLogger();",
  ...
  public void testWriteComplexDebug() {
    ...
    configuration.setDebug(debug);
    assertOutput(getExpectedDetailedDebug(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedDetailedDebug(),
                 true);
  ...
  private String[] getExpectedDetailedDebug() {
    return new String[] { "protected com.mvp4g.rebind.test_tools.OneLogger logger;",
                          "com.mvp4g.rebind.test_tools.OneLogger getcom_mvp4g_rebind_test_tools_OneLogger();",
                          "logger = injector.getcom_mvp4g_rebind_test_tools_OneLogger();",
                          "int startLogDepth = BaseEventBus.logDepth;",
                          "++BaseEventBus.logDepth;",
                          "++BaseEventBus.logDepth;",
                          "BaseEventBus.logDepth = startLogDepth;",
  ...
  public void testWriteChildModuleMethods() {
    ...
    assertOutput(getExpectedChildMethod(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedChildMethod(),
                 true);
  ...
  private String[] getExpectedChildMethod() {
    return new String[] { "parentModule.addConverter(\"child/\" + historyName, hc);",
                          "return parentModule.place(\"child/\" + token, form, onlyToken );",
  ...
  public void testWriteChildModuleMethodsNoHistory() {
    ...
    assertOutput(getExpectedChildMethodNoHistory(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedChildMethodNoHistory(),
                 true);
  ...
  public void testWriteParentHistory() {
    ...
    assertOutput(getExpectedHistoryParent(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedHistoryParent(),
                 true);
  ...
  private String[] getExpectedHistoryParent() {
    return new String[] { "if(\"child\".equals(moduleHistoryName)){",
                          "loadchild(null, nextPasser);",
                          "return;" };
  }
  ...
  public void testWriteGinInjector() {
    ...
    assertOutput(getExpectedGinInjector(),
                 false);
    assertOutput(getExpectedDefaultGinModule(),
                 false);
    assertOutput(getExpectedCustomGinModule(),
                 false);
  ...
  private String[] getExpectedGinInjector() {
    return new String[] { "public interface com_mvp4g_client_Mvp4gModuleGinjector extends Ginjector {",
                          ...
                          "com.mvp4g.rebind.test_tools.annotation.handlers.EventHandlerWithEvent gethandler4();",
  ...
  private String[] getExpectedCustomGinModule() {
    return new String[] { "@GinModules({com.mvp4g.rebind.test_tools.OneGinModule.class,com.mvp4g.client.DefaultMvp4gGinModule.class})" };
  }
  ...
  public void testWriteCustomGinInjector() {
    ...
    createHandlers();
    GinModuleElement ginModule = new GinModuleElement();
    ginModule.setModules(new String[] { OneGinModule.class.getName(),
  ...
  public void testWriteEventFilters() {
    ...
    assertOutput(getExpectedEventFiltersInstantiation(),
                 false);
    assertOutput(getExpectedEventFilters(),
                 false);
  ...
  private String[] getExpectedEventFiltersInstantiation() {
    return new String[] { "com.mvp4g.rebind.test_tools.annotation.EventFilters.EventFilter2 getfilter2();",
                          "com.mvp4g.rebind.test_tools.annotation.EventFilters.EventFilter1 getfilter1();",
                          "final com.mvp4g.rebind.test_tools.annotation.EventFilters.EventFilter2 filter2 = injector.getfilter2();",
                          "eventBus.addEventFilter(filter2);",
                          "final com.mvp4g.rebind.test_tools.annotation.EventFilters.EventFilter1 filter1 = injector.getfilter1();",
                          "eventBus.addEventFilter(filter1);" };
  }

  private String[] getExpectedEventFilters() {
    return new String[] { "if (!filterEvent(\"event2\", new Object[]{attr0})){",
                          "if (!filterEvent(\"event3\")){",
                          "if (!filterEvent(\"event1\", new Object[]{attr0,attr1})){",
                          "return;", };
  }
  ...
  public void testWriteEventFiltersWithLog() {
    ...
    assertOutput(getExpectedEventFilters(),
                 false);
    assertOutput(getExpectedEventFiltersLog(),
                 false);
    assertOutput(getExpectedEventFiltersInstantiation(),
                 false);
  ...
  public void testWriteEventWithPrimitives() {
    ...
    assertOutput(getExpectedPrimitives(),
                 false);
    ...
    e1.setEventObjectClass(new String[] { "boolean",
                                          "byte",
                                          "char",
                                          "double",
                                          "float",
    ...
    configuration.getOthersEventBusClassMap()
                 .put(moduleType.getQualifiedSourceName(),
                      oracle.addClass(EventBusOk.class));
  ...
  public void testWriteSplitter() {
    ...
    configuration.getEventHandlers()
                 .add(eventHandler);

    EventElement e1 = new EventElement();
    e1.setType("event1");
    e1.setSplitters(new String[] { "splitter" });
    e1.setEventObjectClass(new String[] { "int",
                                          "String" });
    ...
    assertOutput(getExpectedSplitter(false),
                 false);
    assertOutput(getExpectedSplitterLoadingConf(),
                 false);
    assertOutput(getExpectedSplitterPassiveGenerateMultiple(),
                 false);
    assertOutput(getExpectedSplitterNotPassive(),
                 false);
    assertOutput(getExpectedSplitterWithLoader(),
                 false);
    writer.writeConf();
    assertOutput(getExpectedSplitter(false),
                 true);
  ...
  private String[] getExpectedSplitter(boolean passive) {
    return new String[] { "private Splitter splitter;",
                          "private void loadsplitter(final String eventName, final Mvp4gEventPasser passer) {",
                          "GWT.runAsync(new RunAsyncCallback(){",
                          "public void onSuccess() {",
                          "if (splitter == null) {",
                          ...
                          "private com.mvp4g.rebind.test_tools.annotation.presenters.SimplePresenter01 presenter;",
                          "public Splitter(){",
                          ...
                          "public void event1(int attr0,String attr1){",
                          "eventHandler.setActivated(true);",
                          "presenter.setActivated(false);",
                          "if (eventHandler.isActivated(" + passive + ", \"event1\", new Object[]{attr0,attr1})){",
                          "eventHandler.onEvent1(attr0,attr1);",
                          "public void event2(){",
                          "eventHandler.setActivated(true);",
                          "presenter.setActivated(false);",
                          "public void event3(){",
                          "presenter.isActivated(false, \"event3\");",
                          "splitter.event2();",
                          "splitter.event3();",
                          "public void pass(Mvp4gModule module){" };
  }
  ...
  private String[] getExpectedSplitterPassiveGenerateMultiple() {
    return new String[] { "List<com.mvp4g.rebind.test_tools.annotation.presenters.SimplePresenter01> handlerspresenterMultiple = eventBus.getHandlers(com.mvp4g.rebind.test_tools.annotation.presenters.SimplePresenter01.class);",
                          ...
                          "eventHandlerMultiple.onEvent4(attr0,attr1,attr2,attr3);",
                          "handler.isActivated(false, \"event3\");",
                          "if (splitter != null ){",
                          "splitter.event1(attr0,attr1);",
                          "public void event4(String attr0,String attr1,String attr2,int attr3){",
  ...
  private String[] getExpectedSplitterNotPassive() {
    return new String[] { "loadsplitter(\"event1\", new Mvp4gEventPasser(new Object[]{attr0,attr1}){",
                          "loadsplitter(\"event2\", new Mvp4gEventPasser(){",
  ...
  private String[] getExpectedSplitterWithLoader() {
    return new String[] { "loader.preLoad( eventBus, eventName, params, new Command(){",
                          "public void execute() {",
                          "loader.onSuccess(eventBus, eventName, params );",
                          "loader.onFailure( eventBus, eventName, params, reason );" };
  }
  ...
  public void testWriteSplitterPassiveLoadingGenerate() {
    ...
    presenterMultiple.setClassName(SimplePresenter01.class.getCanonicalName());
    presenterMultiple.setView("viewMultiple");
    presenterMultiple.setMultiple("true");
    presenter.setAsync("Splitter");
    configuration.getPresenters()
                 .add(presenterMultiple);
    ...
    presenterMultipleWithView.setClassName(SimplePresenter01.class.getCanonicalName());
    ...
    eventHandlerMultiple.setClassName(SimpleEventHandler01.class.getCanonicalName());
    eventHandlerMultiple.setMultiple("true");
    presenter.setAsync("Splitter");
    configuration.getEventHandlers()
                 .add(eventHandlerMultiple);
    ...
    e4.setEventObjectClass(new String[] { "String",
                                          "String",
                                          "String",
                                          "int" });
    ...
    e5.setPassive("true");
    e5.setEventObjectClass(new String[] { "String",
                                          "String",
                                          "String" });
