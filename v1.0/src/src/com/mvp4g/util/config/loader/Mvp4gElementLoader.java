...
abstract class Mvp4gElementLoader<E extends Mvp4gElement> {
	 ...
	 */
	protected abstract String[] getRequiredAttributeNames();
	...
	/**
	 * Specifies a list of optional attribute names that contain multiple, comma-separated values.</p>
	 * 
	 ...
	 * 
	 * @throws InvalidMvp4gConfigurationException if <p/>
	 * 		   <ul>
	 ...
	 * 
	 * @return a subset of Mvp4g elements found in the configuration file or 
	 * 		   an empty set if no elements were found.
	 * 
	 * @throws InvalidMvp4gConfigurationException if <p/>
	 * 		   <ul>
	 * 		   <li/>elements with duplicate identifiers are found;
	...
	private String getAttribute( HierarchicalConfiguration element, String attributeName ) 
	...
	private String[] getAttributeValues( HierarchicalConfiguration element, String attributeName ) 
		throws InvalidMvp4gConfigurationException {
	...
	private void checkForDuplicates(Set<E> loadedElements, E element) 
		throws InvalidMvp4gConfigurationException {
	
		if ( loadedElements.contains( element ) ) {
			String err = "Duplicate " + getElementLabel() + " identified by " +
					"'" + element.getUniqueIdentifierName() + "' found in configuration file.";
			throw new InvalidMvp4gConfigurationException(err);
		}
	}
