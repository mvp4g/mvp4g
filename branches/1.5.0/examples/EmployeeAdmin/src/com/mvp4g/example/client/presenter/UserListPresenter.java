...
public class UserListPresenter
  extends BasePresenter<UserListPresenter.IUserListView, EmployeeAdminEventBus> {
  ...
  void deleteUser() {
    service.deleteUser(users.get(indexSelected - 1),
  ...
  void displayUser(UserBean user,
                   int row) {
    ITable table = view.getTable();
    table.setText(row,
                  0,
