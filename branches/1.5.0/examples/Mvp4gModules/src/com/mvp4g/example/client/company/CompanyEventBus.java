...
import com.mvp4g.example.client.company.presenter.*;
import com.mvp4g.example.client.product.presenter.ProductCreationPresenter;

import java.util.List;

@Events(startPresenter = CompanyListPresenter.class,
...
public interface CompanyEventBus
  ...
  @Event(handlers = CompanyListPresenter.class,
         activate = CompanyRowPresenter.class,
         deactivate = {CompanyEditPresenter.class,
  ...
  @Event(handlers = CompanyCreationPresenter.class,
         activate = CompanyCreationPresenter.class,
         deactivate = {CompanyEditPresenter.class, CompanyDisplayPresenter.class},
         historyConverter = CompanyCreationHistoryConverter.class,
         name = "create",
         navigationEvent = true)
  String goToCreation();
  ...
  @Event(handlers = CompanyDisplayPresenter.class,
         ...
         activate = CompanyDisplayPresenter.class,
         deactivate = {
           CompanyCreationPresenter.class, CompanyEditPresenter.class, ProductCreationPresenter.class, CompanyRowPresenter.class},
         name = "",
         navigationEvent = true)
  ...
  @Event(handlers = CompanyEditPresenter.class,
         activate = {CompanyEditPresenter.class, ProductCreationPresenter.class},
         deactivate = {
  ...
  /* Business Events */
  @Event(handlers = CompanyListPresenter.class,
         activate = CompanyListPresenter.class)
  ...
  @Event(handlers = CompanyListPresenter.class,
         deactivate = CompanyListHandler.class)
  ...
  @Event(handlers = CompanyListHandler.class,
         activate = CompanyListHandler.class)
