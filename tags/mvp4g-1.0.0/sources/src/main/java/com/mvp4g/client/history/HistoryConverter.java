...
public interface HistoryConverter<T> {
	 ...
	 * 			object of the event
	 * @return
	 * 		string to store if the URI. If you don't want to store anything in the URI, return null or empty string.
	 */
	 ...
	 * @param param
	 * 			string that was stored in the token, used to retrieve event's object (can be null if no information was stored in the URI) 
	 * @param eventBus
