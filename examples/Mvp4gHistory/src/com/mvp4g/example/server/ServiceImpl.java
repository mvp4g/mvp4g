...
public class ServiceImpl
  ...
  public ServiceImpl() {
    ...
    ProductBean p1 = new ProductBean("p1",
                                     "Right Soccer Shoe",
                                     "Perfect to score with your right foot, to go with the Left Soccer Shoe",
                                     "$100");
    ProductBean p2 = new ProductBean("p2",
                                     "Left Soccer Shoe",
                                     "Perfect to score with your left foot, to go with the Right Soccer Shoe",
                                     "$100");
    ProductBean p3 = new ProductBean("p3",
                                     "Soccer Ball",
                                     "Ball programmed to go directly in the goal",
                                     "$150");

    products.put(p1.getId(),
                 p1);
    products.put(p2.getId(),
                 p2);
    products.put(p3.getId(),
                 p3);

    DealBean d1 = new DealBean("d1",
                               "Buy one, get one free",
                               "Buy one right shoe, get the left shoe free!!!",
                               "241");
    DealBean d2 = new DealBean("d2",
                               "Free Delivery",
                               "Free delivery on order of $500 or +",
                               "500++");
    DealBean d3 = new DealBean("d3",
                               "Buy one, get 1/2 free",
                               "Buy one soccer goal, get another half free!!!",
                               "1/2");
