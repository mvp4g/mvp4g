...
public class CompanyService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static Map<String, String> loadMethodsJava() {
    ...
    result.put("com.mvp4g.example.client.company.bean.CompanyBean/1983513559", "com.mvp4g.example.client.company.bean.CompanyBean_FieldSerializer");
    result.put("[Lcom.mvp4g.example.client.company.bean.CompanyBean;/631432966", "com.mvp4g.example.client.company.bean.CompanyBean_Array_Rank_1_FieldSerializer");
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.mvp4g.example.client.company.bean.CompanyBean/1983513559"] = [
        @com.mvp4g.example.client.company.bean.CompanyBean_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.mvp4g.example.client.company.bean.CompanyBean_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/mvp4g/example/client/company/bean/CompanyBean;),
        @com.mvp4g.example.client.company.bean.CompanyBean_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/mvp4g/example/client/company/bean/CompanyBean;)
      ];
    
    result["[Lcom.mvp4g.example.client.company.bean.CompanyBean;/631432966"] = [
        @com.mvp4g.example.client.company.bean.CompanyBean_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.mvp4g.example.client.company.bean.CompanyBean_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/mvp4g/example/client/company/bean/CompanyBean;),
      ];
  ...
  private static Map<String, String> loadSignaturesJava() {
    ...
    result.put("com.mvp4g.example.client.company.bean.CompanyBean", "com.mvp4g.example.client.company.bean.CompanyBean/1983513559");
    result.put("[Lcom.mvp4g.example.client.company.bean.CompanyBean;", "[Lcom.mvp4g.example.client.company.bean.CompanyBean;/631432966");
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.mvp4g.example.client.company.bean.CompanyBean::class)] = "com.mvp4g.example.client.company.bean.CompanyBean/1983513559";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.mvp4g.example.client.company.bean.CompanyBean[]::class)] = "[Lcom.mvp4g.example.client.company.bean.CompanyBean;/631432966";
  ...
  public CompanyService_TypeSerializer() {
